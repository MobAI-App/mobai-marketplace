...
function saveBase64Screenshot(base64Data, prefix = "dsl") {
...
server.setRequestHandler(ListToolsRequestSchema, async () => {
    return {
        tools: [
            {
                name: "http_request",
                description: "LOW-LEVEL HTTP API - Prefer mobai:native-runner or mobai:web-runner skills for automation.\n\n" +
                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        url: {
                            type: "string",
                            description: "The URL to request (e.g., http://127.0.0.1:8686/api/v1/devices)",
                        },
                        body: {
                            type: "string",
                            description: "Request body as JSON string (for POST, PUT, PATCH). Example: {\"index\": 5}",
                        },
                        headers: {
                            type: "object",
                        ...
                        timeout: {
                            type: "number",
                            description: "Request timeout in milliseconds. Default: 600000 (10 minutes). Use higher values for agent/run endpoint.",
                        },
                    },
                    required: ["method", "url"],
                },
